...
export ZSH=/home/nebril/.oh-my-zsh
...
alias ciliumpod='echo "${$(kubectl -n kube-system get pod -l k8s-app=cilium --output=name)##*/}"'
#
export RUN_ON_BTRFS_ANYWAY=trolo

alias alert='paplay /usr/share/sounds/gnome/default/alerts/drip.ogg'

alias usd='curl -s https://kantor.aliorbank.pl/chart/USD/json | jq ".actualBuyRate"'
